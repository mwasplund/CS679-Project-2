...
function LoadShader(i_ShaderName)
{
  ...
  var VertexShader_URL = "Shader/" + Shader.Name + ".vs"
  $.ajax({
     url: VertexShader_URL,
     type: "GET",
     dataType: "xml",
     success: function(Data)
     {
       ...
       if (gl.getShaderParameter(Shader.VertexShader, gl.COMPILE_STATUS)) 
         ...
         alert("Error Loading Vertex Shader " + Shader.Name + ": " + gl.getShaderInfoLog(Shader.VertexShader) + "\n" + Data);
  ...
  var FragmentShader_URL = "Shader/" + Shader.Name + ".fs";
  $.ajax({
     url: FragmentShader_URL,
     type: "GET",
     dataType: "xml",
     success: function(Data)
    {
       ...
       if (gl.getShaderParameter(Shader.FragmentShader, gl.COMPILE_STATUS)) 
         ...
         alert("Error Loading Fragment Shader " + Shader.Name + ": " +gl.getShaderInfoLog(Shader.FragmentShader));
